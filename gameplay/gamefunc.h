...
struct StoryHeader {
    ...
    U32 EventCount;		/* Zaehler mit der höchsten EventNr */
    U32 SceneCount;
...
struct NewScene {
    ...
    U32 Ort;			/* der erfüllt sein muß                 */

    U32 AnzahlderEvents;
    U32 AnzahlderN_Events;

    U32 *events;		/* Nr. der Events, die erfüllt sein müssen */
    U32 *n_events;		/* Nr. der Events, die nicht erfüllt sein müssen */
